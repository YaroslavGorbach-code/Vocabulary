package yaroslavgorbach.koropapps.vocabulary.feature.exercise.exercises.vocabulary.specifications.ui
...
import yaroslavgorbach.koropapps.vocabulary.feature.exercise.exercises.vocabulary.specifications.presentation.SpecificationsViewModel
...
class SpecificationsFragment : Fragment(R.layout.fragment_exercise) {

    companion object {
        private const val ARG_EXERCISE_TYPE = "ARG_EXERCISE_TYPE"

        fun newInstance(exerciseType: ExerciseType) = SpecificationsFragment().apply {
            arguments = bundleOf(
    ...
    private val viewModel by viewModels<SpecificationsViewModel> { viewModelFactory }
