package yaroslavgorbach.koropapps.vocabulary.feature.exercise.exercises.communication.abbreviations.ui
...
class AbbreviationsFragment : Fragment(R.layout.fragment_exercise) {

    companion object {
        private const val ARG_EXERCISE_TYPE = "ARG_EXERCISE_TYPE"

        fun newInstance(exerciseType: ExerciseType): AbbreviationsFragment {
            return AbbreviationsFragment().apply {
                arguments = bundleOf(
    ...
    private val viewModel: AbbreviationsViewModel by viewModels { viewModelFactory }
    ...
    private fun initObservers() {
        viewModel.abbreviation.observe(viewLifecycleOwner) { word ->
